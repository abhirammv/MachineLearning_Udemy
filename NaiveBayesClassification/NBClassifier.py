...
def NaiveBayes(in_data, out_data):
...
if __name__ == "__main__":
    ...
    NaiveBayesClassifier = NaiveBayes(X_tr, y_tr)
    y_pred = Pred(X_te, NaiveBayesClassifier)
    ConfMtx = GetConfMatrix(y_te, y_pred)
    print(ConfMtx)
    visualize(X_tr, y_tr, NaiveBayesClassifier, "training")
    visualize(X_te, y_te, NaiveBayesClassifier, "test")
