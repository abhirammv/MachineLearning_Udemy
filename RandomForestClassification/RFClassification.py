...
def RFClassify(in_data, out_data):
...
if __name__ == "__main__":
    ...
    RFClassifier = RFClassify(X_tr, y_tr)
    y_pred = Pred(X_te, RFClassifier)
    ConfMtx = GetConfMatrix(y_te, y_pred)
    print(ConfMtx)
    visualize(X_tr, y_tr, RFClassifier, "training")
    visualize(X_te, y_te, RFClassifier, "test")
